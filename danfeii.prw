...
oDanfe:Box(408+nAjustaVt,100,432+nAjustaVt,200)
oDanfe:Say(418+nAjustaVt,102,"ESPECIE",oFont08N:oFont)
oDanfe:Say(428+nAjustaVt,102,Iif(!Empty(aTransp[12]),aTransp[12],Iif(Len(aEspVol)>0,aEspVol[1][1],"")),oFont08:oFont)
//oDanfe:Say(428,102,aEspVol[1][1],oFont08:oFont)
oDanfe:Box(408+nAjustaVt,200,432+nAjustaVt,301)
oDanfe:Say(418+nAjustaVt,202,"MARCA",oFont08N:oFont)
oDanfe:Say(428+nAjustaVt,202,aTransp[13],oFont08:oFont)
oDanfe:Box(408+nAjustaVt,300,432+nAjustaVt,400)
oDanfe:Say(418+nAjustaVt,302,"NUMERAÇÃO",oFont08N:oFont)
oDanfe:Say(428+nAjustaVt,302,aTransp[14],oFont08:oFont)
oDanfe:Box(408+nAjustaVt,400,432+nAjustaVt,501)
oDanfe:Say(418+nAjustaVt,402,"PESO BRUTO",oFont08N:oFont)
oDanfe:Say(428+nAjustaVt,402,Iif(!Empty(aTransp[15]),aTransp[15],Iif(Len(aEspVol)>0 .And. Val(aEspVol[1][3])>0,Transform(Val(aEspVol[1][3]),"@E 999999.9999"),"")),oFont08:oFont)
//oDanfe:Say(428,402,Iif (!Empty(aEspVol[1][3]),Transform(val(aEspVol[1][3]),"@E 999999.9999"),""),oFont08:oFont)
oDanfe:Box(408+nAjustaVt,500,432+nAjustaVt,603)
oDanfe:Say(418+nAjustaVt,502,"PESO LIQUIDO",oFont08N:oFont)
oDanfe:Say(428+nAjustaVt,502,Iif(!Empty(aTransp[16]),aTransp[16],Iif(Len(aEspVol)>0 .And. Val(aEspVol[1][2])>0,Transform(Val(aEspVol[1][2]),"@E 999999.9999"),"")),oFont08:oFont)
